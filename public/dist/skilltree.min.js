(function($, ko){
	...
	(function(ns) {
		...
		var Calculator = ns.Calculator = function(_e, $http){

			var e = _e || {};
			var self = function(){};

			self.save = function(){
				$http.put('/api/student/'+e.student_id+'/dungeons/'+e.dungeon_id+'/dungeon_hashes/:id', {hash: self.hash()}).success(function(data, status, headers, config) {
				}).
			...
			//Avatar properties
			self.avatarName = ko.observable(e.myName);
			self.emailAddress = ko.observable(e.emailAddress);
			...
			self.stats = ko.computed(function(){
				...
				var totals = $.extend({}, e.defaultStats);
